...
* **Operational Efficiency:**
    * **Avg ER Time:** 65.63 minutes (Tracked by Department).
...
* **Demographics:**
    * Gender distribution (48.9% Female, 51.1% Male).
...
3. Use the top navigation bar to switch between summary and detail views.
